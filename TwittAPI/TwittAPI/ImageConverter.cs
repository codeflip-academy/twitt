...
//        public byte[] ConvertImageToByteArray(System.Drawing.Imaging imageToConvert, System.Drawing.Imaging.ImageFormat formatOfImage)
//        {
//            byte[] ret;
...
//                    System.Data.SqlClient.SqlCommand insertCommand = ("INSERT INTO Profile (Picture) VALUES (1, @pic)", connection);
...
//                    System.Data.SqlClient.SqlCommand insertCommand = ("INSERT INTO Post (Picture) VALUES (1, @pic)", connection);
//                    insertCommand.Parameters.Add(@"pic", SqlDBType.Image, 0).Value = ConvertImageToByteArray(image, System.Drawing.Imaging.ImageFormat, Jpeg);
...
//                selectCommand = new System.Data.SqlClient.SqlCommand("SELECT Picture from Profile where ID =" +
//                    context.Request.QueryString["ID"], connection);
...
//                selectCommand = new System.Data.SqlClient.SqlCommand("SELECT Picture from Post where ID =" +
//                    context.Request.QueryString["ID"], connection);
